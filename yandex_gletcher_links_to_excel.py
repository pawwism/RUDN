...
"""
Глетчер — Маренго силк (серый тёмный):
публикация изображений на Яндекс.Диске и выгрузка ссылок в Excel.

Положите этот файл рядом с token.txt и запустите:
    python .\yandex_gletcher_links_to_excel.py

Результат:
    Глетчер_Маренго_силк_ссылки.xlsx
    gletcher_links_log.txt
"""
...
YANDEX_FOLDER = (
    ...
    "Модули: Глетчер - Маренго силк (серый тёмный)"
)

OUTPUT_XLSX = BASE_DIR / "Глетчер_Маренго_силк_ссылки.xlsx"
LOG_FILE = BASE_DIR / "gletcher_links_log.txt"
...
def main() -> None:
    ...
    log("🚀 Старт: выгрузка ссылок Глетчер — Маренго силк")
